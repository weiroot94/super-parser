...
import { segment_reference } from './segment_reference.js';
...
class presentation_timeline {
  ...
  */
  notifySegments(references) {
    ...
    logger.sp_debug(filePath, 'notifySegments:',
  ...
  */
  notifyMaxSegmentDuration(maxSegmentDuration) {
    ...
    logger.sp_debug(filePath, `notifyNewSegmentDuration: maxSegmentDuration=${this.maxSegmentDuration_}`);
  }
  ...
  assertIsValid() {
    ...
    if (true) {
      if (this.isLive()) {
        ...
        // and static.
        assert(this.segmentAvailabilityDuration_ == Infinity &&
          this.duration_ != Infinity &&
          this.static_,
...
export default presentation_timeline;